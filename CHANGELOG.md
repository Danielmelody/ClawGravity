...
- **Multi-platform support**: Platform abstraction layer for Discord + Telegram ([#67](https://github.com/Danielmelody/ClawGravity/pull/67))
...
- `/output` command to toggle between Embed and plain-text output format ([#54](https://github.com/Danielmelody/ClawGravity/pull/54))
- `/logs` slash command to view recent bot logs from Discord ([#53](https://github.com/Danielmelody/ClawGravity/pull/53))
- `/join` command to take over an existing Antigravity session ([#37](https://github.com/Danielmelody/ClawGravity/pull/37))
- `/mirror` command to toggle PC→Discord message mirroring ([#37](https://github.com/Danielmelody/ClawGravity/pull/37))
- Auto update check on startup ([#35](https://github.com/Danielmelody/ClawGravity/pull/35))
- `ANTIGRAVITY_PATH` environment variable for Linux/custom installations ([#43](https://github.com/Danielmelody/ClawGravity/pull/43))
- OSS standard files (CONTRIBUTING, SECURITY, CODE_OF_CONDUCT) and CI build step ([#57](https://github.com/Danielmelody/ClawGravity/pull/57))
...
- Simplified logger: removed file transport, added verbose debug mode ([#33](https://github.com/Danielmelody/ClawGravity/pull/33))
...
[0.3.0]: https://github.com/Danielmelody/ClawGravity/compare/v0.2.0...v0.3.0
[0.2.0]: https://github.com/Danielmelody/ClawGravity/compare/v0.1.0...v0.2.0
[0.1.0]: https://github.com/Danielmelody/ClawGravity/releases/tag/v0.1.0
