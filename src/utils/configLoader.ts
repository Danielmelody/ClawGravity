...
const CONFIG_DIR_NAME = '.claw-gravity';
const CONFIG_FILE_NAME = 'config.json';
const DEFAULT_DB_NAME = 'antigravity.db';

/**
 * JSON-serializable shape stored in ~/.claw-gravity/config.json.
...
export const ConfigLoader = {
    /** Return the config directory path (~/.claw-gravity/). */
    getConfigDir,

    /** Return the full path to config.json. */
    getConfigFilePath,

    /** Return the default database file path (~/.claw-gravity/antigravity.db). */
    getDefaultDbPath,

    /** Check whether ~/.claw-gravity/config.json exists on disk. */
    ...
    /**
     * Persist the given config to ~/.claw-gravity/config.json.
